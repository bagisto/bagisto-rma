...
<x-slot:title>
    ...
    <div class="content full-page">
        ...
        <div class="page-content">
            <v-tabs
                name="('rma::app.admin.rma-tab-name.tab-content.information') }}"
                :selected="true"
                >
                <br>
                <div class="sale-container">
                    <v-accordion>
                    <div class="flex justify-between items-center" :active="true">
                        <p class="text-[20px] text-gray-800 dark:text-white font-bold">
                            @lang('rma::app.admin.rma-tab-name.tab-content.rma-details')
                ...
                <div class="sale-container">
                    <v-accordion>
                        <div class="flex justify-between items-center" :active="true">
                            <p class="text-[20px] text-gray-800 dark:text-white font-bold">
                                @lang('rma::app.admin.rma-tab-name.tab-content.status')
                            ...
                            <div slot="body">
                                <div class="sale-section">
                                    <div class="section-content">
                                        <div class="flex  gap-[20px] items-center max-sm:flex-wrap">
                                            <span class="py-[11px] text-[15px] text-gray-800 dark:text-white font-medium">
                                                ...
                                                <span class="value" @if($rmaData['status'] == 1) style="display: none;" @endif>
                                                    @if (empty($rmaData['rma_status']) || $rmaData['rma_status']=='Pending')
                                                        <span id="tag" class="tagbutton" style="border-radius:35px; background-color:#FBC02D">
                                                    ...
                                                    @elseif ($rmaData['rma_status'] == 'Not Receive Package yet')
                                                        <span class="tagbutton" style="border-radius:35px; background-color:#FBC02D">
                                                    ...
                                                    @elseif ($rmaData['rma_status'] == 'Accept')
                                                        <span class="tagbutton" style="border-radius:35px; background-color:#125112">
                                            ...
                                            <div class="flex  gap-[20px] items-center max-sm:flex-wrap">
                                                ...
                                                <span
                                                    ...
                                                    @if($rmaData['order_status'] == 'Delivered')
                                                        style="border-radius:35px; background-color:#2E7D32; color: white;"
                                                    @else
                                                        style="border-radius:35px; background-color:#d32f2f; color: white;"
                                                    @endif>
                                    ...
                                    <div class="sale-section" >
                                        <div class="flex justify-between items-center">
                                            <p class="text-[18px] text-gray-800 dark:text-white font-bold">
                                                @lang('rma::app.admin.rma-tab-name.tab-content.change-status')
                                            </p>
                                        </div>
                                        <div class="section-content">
                                            <div class="">
                ...
                <div class="sale-container">
                    <v-accordion>
                        <div class="flex justify-between items-center" :active="true">
                            <p class="text-[20px] text-gray-800 dark:text-white font-bold">
                                @lang('rma::app.admin.rma-tab-name.tab-content.order-details')     
                            </p>
                        </div>
                        <div slot="body">
                            <div class="sale-section">
                ...
                <div class="sale-container">
                    <v-accordion>
                        <div class="flex justify-between items-center" :active="true">
                            <p class="text-[20px] text-gray-800 dark:text-white font-bold">
                                @lang('rma::app.admin.rma-tab-name.tab-content.conversation') ({{ count($adminMessages) }})
                            ...
                            <div class="sale-section">
                                <div class="section-content">
                                    <div class="secton-title">
                                        ...
                                        <x-shop::form method="POST"  action="{{ route('admin.rma.sendmessage') }}">
                                            @csrf()
