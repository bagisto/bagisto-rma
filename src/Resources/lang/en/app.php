...
return [
    'shop' => [
        ...
        'customer-rma-create' => [
            ...
            'not_allowed' => 'RMA is not allowed for pending order',
            'image' => 'Image',
            'quantity' => 'Quantity',
            'reason' => 'Reason',
            'select_seller' => 'Select Seller',
            'rma-not-avilable-quotes' => 'Item not avilable for RMA',
    ...
    'response' => [
        ...
        'mass-update-success' => 'RMA updated successfully.',
        'delete-success' => 'Reason deleted successfully.',
        'mass-delete-success' => 'Reason deleted successfully.',
