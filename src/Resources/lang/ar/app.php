...
return [
    'shop' => [
        ...
        'customer-rma-create' => [
            ...
            'orders' => 'أوامر',
            'resolution' => 'حدد الدقة',
            'item-ordered' => 'تم طلب العنصر',
            'images' => 'الصور',
            'information' => 'معلومة اضافية',
            ...
            'not_allowed' => 'RMA غير مسموح به للأمر المعلق',
            'image' => 'صورة',
            'quantity' => 'كمية',
            'reason' => 'السبب',
            'select_seller' => 'حدد البائع',
            'rma-not-avilable-quotes' => 'العنصر غير متوفر لـ RMA',
            'product-name' => 'اسم المنتج',
            'reopen_request' => 'إعادة فتح الطلب',
        ],
        ...
        'view-customer-rma' => [
            ...
            'status-details' => 'Status Details',
            'admin' => 'Admin',
            'status-quotes' => 'الرجاء الموافقة على وضع علامة على الحل.',
            'save-btn' => 'حفظ',
            'close-rma' => 'Close RMA',
            'images' => 'Images',
            'items-request' => 'Item(s) Requested for RMA',
        ...
        'view-customer-rma-content' => [
            ...
            'full-amount' => 'Full Amount',
            'partial-amount' => 'Partial Amount',
            'total-refundable-amount' => 'إجمالي المبلغ المسترد:',
    ...
    'admin' => [
        ...
        'general' => [
            'rma_has_been_created' => 'RMA has been created for this item.'
        ],
