            ...
            >
                ...
                <x-shop::form.control-group class="mb-4">
                    <x-shop::form.control-group.label class="required">
                        @lang('rma::app.shop.guest.create.enter-order-id')
                    ...
                    <x-shop::form.control-group.control
                        ...
                        :placeholder="trans('rma::app.shop.guest.create.enter-order-id')"
                    >
                    </x-shop::form.control-group.control>
                    ...
                    >
                        @lang('rma::app.shop.guest.create.search-order')
                    </button>
                ...
                <x-shop::form.control-group  v-if="resolutions != ''" class="mb-4">
                    <x-shop::form.control-group.label  class="required">
                        @lang('rma::app.shop.guest.create.resolution')
                    </x-shop::form.control-group.label>
                ...
                <x-shop::form.control-group v-if="orderStatus" class="mb-4">
                    <x-shop::form.control-group.label class="required">
                        @lang('rma::app.shop.guest.create.order-status')
                    </x-shop::form.control-group.label>
                    ...
                    >
                        <p>
                            @lang('rma::app.shop.guest.create.not-allowed')
                        </p>
                    </x-shop::form.control-group.error>
                </x-shop::form.control-group>
                <br>
                ...
                <div class="flex items-center justify-between">
                    <p class="text-[26px] font-medium">
                        @lang('rma::app.shop.guest.create.item-ordered')
                    </p>
                </div>
                ...
                <div class="mt-[15px] overflow-x-auto">
                    <table class="w-full text-left text-sm">
                        <thead  class="border-b-[1px] border-[#E9E9E9] bg-[#F5F5F5] text-[14px] text-black">
                            <tr>
                                ...
                                >
                                    @lang('rma::app.shop.guest.create.image')
                                </th>
                                ...
                                <th
                                    ...
                                    class="px-6 py-[16px] font-medium"
                                >
                                    @lang('rma::app.shop.guest.create.product')
                                </th>
                                ...
                                <th
                                    ...
                                    class="px-6 py-[16px] font-medium"
                                >
                                    @lang('rma::app.shop.guest.create.sku')
                                </th>
                                ...
                                <th
                                    ...
                                    class="px-6 py-[16px] font-medium"
                                >
                                    @lang('rma::app.shop.guest.create.price')
                                </th>
                                ...
                                <th
                                    ...
                                    class="px-6 py-[16px] font-medium"
                                >
                                    @lang('rma::app.shop.guest.create.quantity')
                                </th>
                                ...
                                <th
                                    ...
                                    class="px-6 py-[16px] font-medium"
                                >
                                    @lang('rma::app.shop.guest.create.reason')
                                </th>
                            </tr>
                        </thead>
                    ...
                    <div v-if="seller == true && resolutionShow == true">
                        <div v-if="sellerOrderedData.length == 0">
                            <p>
                                @lang('rma::app.shop.guest.create.rma-not-available-quotes')
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center justify-between">
                        <h2 class="text-[26px] font-medium">
                            @lang('rma::app.shop.guest.create.images')
                        </h2>
                    </div>
                    ...
                    <div class="p-[16px]">
                        <x-shop::form.control-group class="mb-[10px]">
                            <x-shop::form.control-group.label class="text-[26px] font-medium">
                                @lang('rma::app.shop.guest.create.information')
                            </x-shop::form.control-group.label>
                            ...
                            <x-shop::form.control-group.control
                                ...
                                name="information"
                                id="information"
                                :label="trans('rma::app.shop.guest.create.information')"
                                :placeholder="trans('rma::app.shop.guest.create.information')"
                                rows="3"
                            >
                            </x-shop::form.control-group.control>
                ...
                <div class="account-action">
                    <button
                        ...
                        class="primary-button"
                    >
                        @lang('rma::app.shop.guest.create.create-btn')
                    </button>
                </div>
            </x-shop::form>
        </script>
                    ...
                    getResolutions: function (event) {
                        ...
                        .then(response => {
                            if (response.status == 200) {
                                this_this.orderItems = response.data.search_results.data;
